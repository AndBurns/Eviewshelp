...
'The following variables were in exogenous mode but were ucnhanged
{%model}.exclude(m) BGDNYTAXNINDKN_A BGDNVAGRTOTLKN BGDNVINDTOTLKN BGDNYGDPCPSHXN BGDNVAGRTOTLXN BGDNVINDTOTLXN BGDNYTAXNINDCN_A
...
MShold.fill(o=2024)   25444.7730514042, 30638.6241834039, 49408.6040873426, 66262.8934283178, 82781.7977725486, 102763.246534143, 132176.412589548
...
smpl %fcst_start %solve_end
series BGDFIRESTOTLCD_A_S =  hold
...
'The following variables were in exogenous mode but were ucnhanged
{%model}.exclude(m) BGDBXGSRMRCHCD BGDBMGSRMRCHCD BGDBXFSTREMTCD BGDBXFSTOTHRCD BGDBMFSTREMTCD BGDBMFSTOTHRCD BGDNYGDPMKTPCD BGDBFCAFFFDICD BGDBFCAFFPFTCD BGDBFCAFOOTHCD BGDBFCAFCAPTCD BGDBFCAFNEOMCD BGDBFCAFRACGCD_A
...
%Fname="C:\WBG\LocalITUtilities\BGD\Data\BGD2024-14-02~01-39-43soln.wf1"
wfsave(2) %Fname
close BGD2024-14-02~01-39-43soln
wfselect BGDsoln
