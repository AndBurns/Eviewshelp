...
'		%l_population = "BGDSPPOP1564TO BGDSPPOPTOTL"
	...
	'Call subtroutine
		call extend_forecast(%cty,%forecast_start,%forecast_end,%l_constant,%l_value,%l_volume,%l_price,%l_wage,%l_population,%l_dummy,!inflexpt,!tfpgrowth,!labshare) ',!popgrowth
