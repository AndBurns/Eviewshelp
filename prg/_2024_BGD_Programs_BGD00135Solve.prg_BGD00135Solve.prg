...
'Exclusion for row #12, Var:NYTAXNINDKN_A
...
MShold.fill(o=2024)   5.88059165253469, 6.89001841867665, 7.59567930484386, 7.19415002957999, 6.94379773795715, 6.7876776265317, 6.7287903375737
series yg=mshold+hold
smpl @all
series BGDNYTAXNINDKN_A_2 = BGDNYTAXNINDKN_A
smpl %fcst_start %fcst_end

_BGDNYTAXNINDKN.fit fit
...
smpl @all
series BGDNYTAXNINDKN_A_2 = BGDNYTAXNINDKN_A
series orig_AF = BGDNYTAXNINDKN_A
series y = BGDNYTAXNINDKN_0
smpl %fcst_start %solve_end
'
...
series orig_add_AF = BGDNYTAXNINDKN_A 
series BGDNYTAXNINDKN_A_S = BGDNYTAXNINDKN_A
'Now caculate the additive add factor _A_S consistent with the desired growth path
smpl %fcst_start %solve_end
series BGDNYTAXNINDKN_A_S = BGDNYTAXNINDKN_A+Y(-1)*(delta_AF_add/100)
series BGDNYTAXNINDKN_A_add = BGDNYTAXNINDKN_A
...
test.override(m) BGDNYTAXNINDKN_A
test.exclude(m)  BGDNYTAXNINDKN_A
...
smpl %solve_start %solve_end
series BGDNYTAXNINDKN = BGDNYTAXNINDKN_s
series BGDNYTAXNINDKN_A = orig_AF


'Calculate new intercept-type add factor
smpl %solve_start %solve_end
{%model}.addinit(v=n,s=a) BGDNYTAXNINDKN
...
series BGDNYTAXNINDKN_A_2 = BGDNYTAXNINDKN_A
series BGDNYTAXNINDKN_A = orig_AF
series BGDNYTAXNINDKN= orig_ser
{%model}.override(m) BGDNYTAXNINDKN_A
{%model}.exclude(m) BGDNYTAXNINDKN_A
...
'The following variables were in exogenous mode but were ucnhanged
{%model}.exclude(m) BGDNVAGRTOTLKN_A BGDNVINDTOTLKN_A BGDNYGDPCPSHXN_A BGDNVAGRTOTLXN_A BGDNVINDTOTLXN_A BGDNYTAXNINDCN_A
...
%Fname="C:\WBG\LocalITUtilities\BGD\Data\BGD2024-14-02~08-20-34soln.wf1"
wfsave(2) %Fname
close BGD2024-14-02~08-20-34soln
wfselect BGDsoln
