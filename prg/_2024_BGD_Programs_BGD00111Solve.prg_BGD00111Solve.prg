...
'Exclusion for row #18, Var:NVINDTOTLKN
'Placing raw data from excel in hold variable for later treatment, and create the shock variable (_2)

hold.fill(o=2024)   8, 9, 9.06557601385185, 8.1495028214196, 7.33625843064323, 6.66814025196745, 6.14359680817285
smpl @all
series BGDNVINDTOTLKN_2 = BGDNVINDTOTLKN
smpl %fcst_start %fcst_end

{%model}.exclude(r) BGDNVINDTOTLKN_A

'Mode set to growth: setting shock value (_2) of series BGDNVINDTOTLKN equal to level consistent with growth rates recorded in excel sheet (hold) 
series BGDNVINDTOTLKN_2 = BGDNVINDTOTLKN_2(-1) * (1 + hold / 100)
{%model}.override(m) BGDNVINDTOTLKN
{%model}.exclude(m) BGDNVINDTOTLKN
{%model}.exclude(r) BGDNVINDTOTLKN_A
...
'The following variables were in exogenous mode but were ucnhanged
{%model}.exclude(m) BGDNYTAXNINDKN_A BGDNVAGRTOTLKN BGDNYGDPCPSHXN BGDNVAGRTOTLXN BGDNVINDTOTLXN BGDNYTAXNINDCN_A
...
%Fname="C:\WBG\LocalITUtilities\BGD\Data\BGD2024-14-02~01-15-17soln.wf1"
wfsave(2) %Fname
close BGD2024-14-02~01-15-17soln
wfselect BGDsoln
