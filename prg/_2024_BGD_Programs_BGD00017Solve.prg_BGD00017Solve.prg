...
'The following variables were in exogenous mode but were ucnhanged
{%model}.exclude(m) BGDGGREVDRCTCN BGDGGREVTVATCN_A BGDGGREVIMPDCN_A BGDGGREVEXPDCN_A BGDGGREVEXCDCN_A BGDGGREVSUPDCN_A BGDGGREVOTHDCN_A BGDGGREVNNBRCN_A BGDGGREVTOTHCN_A BGDGGREVOTHRCN BGDGGREVNONTCN_A BGDGGREVGRNTCN_A
...
'Exclusion for row #7, Var:GGEXPGNFSCN
'Placing raw data from excel in hold variable for later treatment, and create the shock variable (_2)

hold.fill(o=2023)   0.751238729410987, 0.710094257185952, 1.7, 0.651153475800662, 0.630907363992004, 0.614418653775894, 0.601152608801438, 0.590680270924654
smpl @all
series BGDGGEXPGNFSCN_2 = BGDGGEXPGNFSCN
smpl %fcst_start %fcst_end

{%model}.exclude(r) BGDGGEXPGNFSCN_A

'Mode set to %gdp: setting shock value (_2) of series BGDGGEXPGNFSCN equal to level consistent with percent of GDP recorded in excel sheet (hold) 
series BGDGGEXPGNFSCN_2 = (hold / 100) * BGDNYGDPMKTPCN
{%model}.override(m) BGDGGEXPGNFSCN
{%model}.exclude(m) BGDGGEXPGNFSCN
{%model}.exclude(r) BGDGGEXPGNFSCN_A
...
'The following variables were in exogenous mode but were ucnhanged
{%model}.exclude(m) BGDGGEXPWAGECN_A BGDGGEXPTRNSCN_A BGDINTRDDIFFFR_A BGDINTREDIFFFR_A BGDGGEXPCAPTCN_A BGDGGEXPOTHRCN
...
%Fname="C:\WBG\LocalITUtilities\BGD\Data\BGD2024-05-02~11-25-26soln.wf1"
wfsave(2) %Fname
close BGD2024-05-02~11-25-26soln
wfselect BGDsoln
