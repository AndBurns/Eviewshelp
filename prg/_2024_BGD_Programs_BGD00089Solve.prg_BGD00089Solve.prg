...
hold.fill(o=2024)   10, 10, 8.70396113984944, 9.54197719023937, 10.3030585404675, 11.0520039440349, 11.8083595728383
smpl @all
...
'Mode set to growth: setting shock value (_2) of series BGDGGEXPGNFSCN equal to level consistent with growth rates recorded in excel sheet (hold) 
series BGDGGEXPGNFSCN_2 = BGDGGEXPGNFSCN_2(-1) * (1 + hold / 100)
...
'The following variables were in exogenous mode but were ucnhanged
{%model}.exclude(m) BGDGGEXPWAGECN BGDGGEXPTRNSCN BGDINTRDDIFFFR BGDINTREDIFFFR BGDUSAINTRFR BGDGGEXPCAPTCN BGDGGEXPOTHRCN
...
%Fname="C:\WBG\LocalITUtilities\BGD\Data\BGD2024-14-02~00-53-09soln.wf1"
wfsave(2) %Fname
close BGD2024-14-02~00-53-09soln
wfselect BGDsoln
