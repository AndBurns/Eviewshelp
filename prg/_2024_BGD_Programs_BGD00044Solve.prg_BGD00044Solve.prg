...
hold.fill(o=2023)   6, 6, 6, 6, 6, 6, 6, 6
smpl @all
...
'Exclusion for row #35, Var:NYGDPDISCKN
'Placing raw data from excel in hold variable for later treatment, and create the shock variable (_2)
...
{%model}.exclude(m) BGDNYGDPTFP BGDNEGDIFPRVKN BGDNEGDISTKBKN BGDNEEXPGNFSKN BGDNEIMPGNFSKN
...
%Fname="C:\WBG\LocalITUtilities\BGD\Data\BGD2024-11-02~03-57-24soln.wf1"
wfsave(2) %Fname
close BGD2024-11-02~03-57-24soln
wfselect BGDsoln
