...
'***************************************************
	cd %extractpath
	for %a BGDdataforupdate external commodities
		read(t=xls,B1,s={%a},t) {%cty}dataforupdate.xls 400
		logmsg read data {%a} done
	next
...
'********************
	...
	series {%cty}NYGDPTFP_raw = ({%cty}NYGDPMKTPKN) / (BGDSPPOP1564TO^BGDNYYWBTOTLCN_*BGDNEGDIKSTKKN(-1)^(1-BGDNYYWBTOTLCN_))
	...
	series BGDNYGDPPOTLKN  = (BGDNYGDPTFP  * BGDSPPOP1564TO^BGDNYYWBTOTLCN_  * BGDNEGDIKSTKKN(-1)^(1-BGDNYYWBTOTLCN_))
