...
'*******************************************************
	'VOLUMES
		...
		smpl 1986 2015
			c = 0
		' ' ' equation _BGDNECONPRVTKN.LS DLOG(BGDNECONPRVTKN) = C(1) - C(2) * (LOG(BGDNECONPRVTKN(-1)) - LOG((BGDNYYWBTOTLCN_(-1)*BGDNYGDPMKTPCN(-1)*(1-BGDGGREVDRCTER(-1)/100)+BGDBXFSTREMTCD(-1)*BGDPANUSATLS(-1))/BGDNECONPRVTXN(-1))) + C(3) * DLOG((BGDNYYWBTOTLCN_*BGDNYGDPMKTPCN*(1-BGDGGREVDRCTER/100)+BGDBXFSTREMTCD*BGDPANUSATLS)/BGDNECONPRVTXN) 
		' ' equation _BGDNECONPRVTKN.LS DLOG(BGDNECONPRVTKN) = C(1) -  0.162618831264 * (LOG(BGDNECONPRVTKN(-1)) - LOG((BGDNYYWBTOTLCN_(-1)*BGDNYGDPMKTPCN(-1)*(1-BGDGGREVDRCTER(-1)/100)+BGDBXFSTREMTCD(-1)*BGDPANUSATLS(-1))/BGDNECONPRVTXN(-1))) + 0.790518869487 * DLOG((BGDNYYWBTOTLCN_*BGDNYGDPMKTPCN*(1-BGDGGREVDRCTER/100)+BGDBXFSTREMTCD*BGDPANUSATLS)/BGDNECONPRVTXN) - C(5) * D(BGDFMLBLPOLYFR/100-DLOG(BGDNECONPRVTXN))
		' equation _BGDNECONPRVTKN.LS DLOG(BGDNECONPRVTKN) = C(1) -  C(2) * (LOG(BGDNECONPRVTKN(-1)) - LOG((BGDNYYWBTOTLCN(-1)*(1-BGDGGREVDRCTER(-1)/100)+BGDBXFSTREMTCD(-1)*BGDPANUSATLS(-1))/BGDNECONPRVTXN(-1))) + C(3) * DLOG((BGDNYYWBTOTLCN*(1-BGDGGREVDRCTER/100)+BGDBXFSTREMTCD*BGDPANUSATLS)/BGDNECONPRVTXN) - C(5) * D(BGDFMLBLPOLYFR/100-DLOG(BGDNECONPRVTXN))
		equation _BGDNECONPRVTKN.LS DLOG(BGDNECONPRVTKN) = C(1) -  C(2) * (LOG(BGDNECONPRVTKN(-1)) - LOG((BGDNYYWBTOTLCN(-1)*(1-BGDGGREVDRCTER(-1)/100)+BGDBXFSTREMTCD(-1)*BGDPANUSATLS(-1)+BGDGGEXPTRNSCN(-1))/BGDNECONPRVTXN(-1))) + C(3) * DLOG((BGDNYYWBTOTLCN*(1-BGDGGREVDRCTER/100)+BGDBXFSTREMTCD*BGDPANUSATLS+BGDGGEXPTRNSCN)/BGDNECONPRVTXN) + C(10) * T_LR
		
		'Reconstructed wage bill with persistent price adjustment
			scalar C_DEFL = 1
			BGD.append @IDENTITY DLOG(BGDNYYWBTOTLCN) = (C_DEFL * DLOG(BGDNYGDPMKTPXN) + (1-C_DEFL) * LOG(1+BGDINFLEXPT/100)) + DLOG(BGDNYGDPMKTPKN)

		smpl %begin_date %end_estimate
			c = 0
		' ' equation _BGDNEGDIFPRVKN.LS DLOG(BGDNEGDIFPRVKN) = C(1) - C(2) * (LOG(BGDNEGDIKSTKKN(-1)) - LOG(1-BGDNYYWBTOTLCN_(-1)) - LOG(BGDNYGDPPOTLKN(-1)) + LOG(BGDNEKRTTOTLXN(-1)/BGDNYGDPFCSTXN(-1))) + C(3) * DLOG(BGDNYGDPMKTPKN) - 0.15 * DLOG(BGDNEKRTTOTLXN/BGDNEGDIFPRVXN) + C(4) * DLOG(BGDNEGDIFPRVKN(-1)) + C(10) * @DURING("1993 1996")
		' equation _BGDNEGDIFPRVKN.LS DLOG(BGDNEGDIFPRVKN) = C(1) - C(2) * (LOG(BGDNEGDIFPRVKN(-1)) - LOG(1-BGDNYYWBTOTLCN_(-1)) - LOG(BGDNYGDPPOTLKN(-1)) + LOG(BGDNEKRTTOTLXN(-1)/BGDNYGDPFCSTXN(-1))) + C(3) * DLOG(BGDNYGDPMKTPKN) - 0.15 * DLOG(BGDNEKRTTOTLXN/BGDNEGDIFPRVXN)  + C(11) * @DURING("1989 1992")
		...
		smpl 1988 %end_estimate
			c = 0
		' equation _BGDNEEXPGNFSKN.LS(OPTMETHOD=LEGACY) DLOG(BGDNEEXPGNFSKN) = C(1) - C(2) * (LOG(BGDNEEXPGNFSKN(-1)) - LOG(BGDXMKT(-1)) + C(3) *LOG(BGDNEEXPGNFSXN(-1)/(BGDPXKEY(-1)*BGDPANUSATLS(-1)))) - C(3) * DLOG(BGDNEEXPGNFSXN/(BGDPXKEY*BGDPANUSATLS)) + C(10) *@DURING("2002 2003")
		equation _BGDNEEXPGNFSKN.LS DLOG(BGDNEEXPGNFSKN) = C(1) - C(2) * (LOG(BGDNEEXPGNFSKN(-1)) - LOG(BGDXMKT(-1)) + C(3) *LOG(BGDNEEXPGNFSXN(-1)/(BGDPXKEY(-1)*BGDPANUSATLS(-1)))) - C(4) * DLOG(BGDNEEXPGNFSXN/(BGDPXKEY*BGDPANUSATLS)) + C(5) * DLOG(BGDXMKT)

		smpl %begin_date %end_estimate
			c = 0
		' ' equation _BGDNEIMPGNFSKN.LS(OPTMETHOD=LEGACY) DLOG(BGDNEIMPGNFSKN) = C(1) - C(2) * (LOG(BGDNEIMPGNFSKN(-1)) - LOG(BGDNEGDETTOTKN(-1)) + C(3) * LOG(BGDNEIMPGNFSXN(-1)/(BGDNECONPRVTXN(-1)))) - C(5) * DLOG(BGDNEIMPGNFSXN/BGDNECONPRVTXN) + 1 * DLOG(BGDNEGDETTOTKN)
		' equation _BGDNEIMPGNFSKN.LS DLOG(BGDNEIMPGNFSKN) = C(1) - C(2) * (LOG(BGDNEIMPGNFSKN(-1)) - LOG(BGDNEGDETTOTKN(-1)) + C(3) * LOG(BGDNEIMPGNFSXN(-1)/(BGDNECONPRVTXN(-1)))) + 1.5 * DLOG(BGDNEGDETTOTKN) - C(5) * DLOG(BGDNEIMPGNFSXN/BGDNECONPRVTXN) + C(10) * T_LR
	...
	'PRICES
		...
		smpl 1986 %end_estimate
			c = 0
		' ' equation _BGDNYGDPFCSTXN.LS @PC(BGDNYGDPFCSTXN) = C(1) * @PC(BGDNYGDPFCSTXN(-1)) + (1-C(1)) * BGDINFLEXPT + C(3) * BGDNYGDPGAP_
		' equation _BGDNYGDPFCSTXN.LS @PC(BGDNYGDPFCSTXN) = BGDINFLEXPT + C(10) * @DURING("1996") + C(11) * @DURING("1991 1994") + C(3) * BGDNYGDPGAP_
		...
		smpl 1997 %end_estimate
			c = 0
		' ' ' ' equation _BGDNECONPRVTXN.LS(OPTMETHOD=LEGACY) DLOG(BGDNECONPRVTXN) = C(1) - C(2) * (LOG(BGDNECONPRVTXN(-1)) - C(3) * LOG(BGDNYGDPFCSTXN(-1)) - (1-C(3)) * LOG(BGDNEIMPGNFSXN(-1)) - LOG((1+BGDGGREVTVATER(-1)/100)*(1+BGDGGREVEXCDER(-1)/100))) + C(4) * DLOG(BGDNYGDPFCSTXN) + (1-C(4)) * DLOG(BGDNEIMPGNFSXN) + C(5) * BGDNYGDPGAP_/100 + DLOG((1+BGDGGREVTVATER/100)*(1+BGDGGREVEXCDER/100))
		' ' equation _BGDNECONPRVTXN.LS(OPTMETHOD=LEGACY) DLOG(BGDNECONPRVTXN) = C(1) - C(2) * (LOG(BGDNECONPRVTXN(-1)) - C(3) * LOG(BGDNYGDPFCSTXN(-1)) - (1-C(3)) * LOG(BGDNEIMPGNFSXN(-1)) - LOG((1+BGDGGREVTVATER(-1)/100)*(1+BGDGGREVEXCDER(-1)/100))) + C(4) * DLOG(BGDNYGDPFCSTXN) + (1-C(4)) * DLOG(BGDNEIMPGNFSXN) + 0.15 * BGDNYGDPGAP_/100 + DLOG((1+BGDGGREVTVATER/100)*(1+BGDGGREVEXCDER/100))
		' equation _BGDNECONPRVTXN.LS DLOG(BGDNECONPRVTXN) = C(1) - 0.25 * (LOG(BGDNECONPRVTXN(-1)) - C(3) * LOG(BGDNYGDPFCSTXN(-1)) - (1-C(3)) * LOG(BGDNEIMPGNFSXN(-1)) - LOG((1+BGDGGREVTVATER(-1)/100)*(1+BGDGGREVEXCDER(-1)/100))) + C(3) * DLOG(BGDNYGDPFCSTXN) + (1-C(3)) * DLOG(BGDNEIMPGNFSXN) + 0.15 * BGDNYGDPGAP_/100 + DLOG((1+BGDGGREVTVATER/100)*(1+BGDGGREVEXCDER/100))
		...
		smpl %begin_date %end_estimate
			c = 0
		equation _BGDNECONGOVTXN.LS DLOG(BGDNECONGOVTXN) = C(1) - C(2) * (LOG(BGDNECONGOVTXN(-1)) - LOG(BGDNECONPRVTXN(-1))) + C(3) * DLOG(BGDNECONPRVTXN) + (1-C(3)) * DLOG(BGDNECONGOVTXN(-1)) + C(10) * @DURING("1998") + C(11) * @DURING("2016")
		...
		smpl 2000 %end_estimate
			c = 0
		equation _BGDNEGDIFPRVXN.LS DLOG(BGDNEGDIFPRVXN) = C(1) - C(2) * (LOG(BGDNEGDIFPRVXN(-1)) - LOG(BGDNECONPRVTXN(-1))) + C(3) * DLOG(BGDNECONPRVTXN) + (1-C(3)) * DLOG(BGDNEGDIFPRVXN(-1)) + C(10) * @DURING("2000")
		
		smpl %begin_date %end_estimate
			c = 0
		' equation _BGDNEEXPGNFSXN.LS(OPTMETHOD=LEGACY) DLOG(BGDNEEXPGNFSXN) = C(1) - C(2) * (LOG(BGDNEEXPGNFSXN(-1)) - C(3) * LOG((1+BGDGGREVEXPDER(-1)/100)*BGDNECONPRVTXN(-1)/(1+BGDGGREVTVATER(-1)/100)) - (1-C(3)) * LOG(BGDPXKEY(-1)*BGDPANUSATLS(-1))) + C(4) * DLOG((1+BGDGGREVEXPDER/100)*BGDNECONPRVTXN/(1+BGDGGREVTVATER/100)) + (1-C(4)) * DLOG(BGDPXKEY*BGDPANUSATLS) + C(10) * @DURING("2004")
		equation _BGDNEEXPGNFSXN.LS DLOG(BGDNEEXPGNFSXN) = C(1) - 0.25 * (LOG(BGDNEEXPGNFSXN(-1)) - C(3) * LOG((1+BGDGGREVEXPDER(-1)/100)*BGDNECONPRVTXN(-1)/(1+BGDGGREVTVATER(-1)/100)) - (1-C(3)) * LOG(BGDPXKEY(-1)*BGDPANUSATLS(-1))) + C(4) * DLOG((1+BGDGGREVEXPDER/100)*BGDNECONPRVTXN/(1+BGDGGREVTVATER/100)) + (1-C(4)) * DLOG(BGDPXKEY*BGDPANUSATLS) + C(10) * @DURING("2004") + C(11) * @DURING("1980 2003")
		
		smpl %begin_date %end_estimate
			c = 0
		' equation _BGDNEIMPGNFSXN.LS(OPTMETHOD=LEGACY) DLOG(BGDNEIMPGNFSXN) = C(1) - C(2) * (LOG(BGDNEIMPGNFSXN(-1)) - C(3) * LOG(BGDNECONPRVTXN(-1)/(1+BGDGGREVTVATER(-1)/100)) - (1-C(3)) * LOG((1+BGDGGREVIMPDER(-1)/100)*BGDPMKEY(-1)*BGDPANUSATLS(-1))) + C(4) * DLOG(BGDNECONPRVTXN/(1+BGDGGREVTVATER/100)) + (1-C(4)) * DLOG((1+BGDGGREVIMPDER/100)*BGDPMKEY*BGDPANUSATLS)  + C(10) * @DURING("2004")
	...
	'REVENUES
		...
		'TAX REVENUES
			...
			' Import duty
				smpl %begin_date %end_estimate
					c = 0
				equation _BGDGGREVIMPDCN.LS BGDGGREVIMPDCN = BGDGGREVIMPDER(-1) / 100 * BGDNEIMPGNFSCN + C(1) * @DURING("2010")
			...
			' Export duty
				smpl %begin_date %end_estimate
					c = 0
				equation _BGDGGREVEXPDCN.LS BGDGGREVEXPDCN = BGDGGREVEXPDER(-1) / 100 * BGDNEEXPGNFSCN + C(1) * @DURING("2010")
			...
			' VAT
				smpl %begin_date %end_estimate
					c = 0
				equation _BGDGGREVTVATCN.LS BGDGGREVTVATCN = BGDGGREVTVATER(-1) / 100 * (BGDNECONPRVTCN + BGDNECONGOVTCN) + C(1) * @DURING("2010")
			...
			' Excise duties
				smpl %begin_date %end_estimate
					c = 0
				equation _BGDGGREVEXCDCN.LS BGDGGREVEXCDCN = BGDGGREVEXCDER(-1) / 100 * (BGDNECONPRVTCN + BGDNECONGOVTCN) + C(1) * @DURING("2010")
			...
			' Direct Tax
				smpl %begin_date %end_estimate
					c = 0
				equation _BGDGGREVDRCTCN.LS BGDGGREVDRCTCN = BGDGGREVDRCTER(-1) / 100 * BGDNYGDPMKTPCN + C(1) * @DURING("2010")
			...
			' Supplementary duties
				smpl %begin_date %end_estimate
					c = 0
				equation _BGDGGREVSUPDCN.LS BGDGGREVSUPDCN = BGDGGREVSUPDER(-1) / 100 * (BGDNECONPRVTCN + BGDNECONGOVTCN) + C(1) * @DURING("2010")
			...
			' Other taxes and duties
				smpl %begin_date %end_estimate
					c = 0
				equation _BGDGGREVOTHDCN.LS BGDGGREVOTHDCN = BGDGGREVOTHDER(-1) / 100 * BGDNYGDPMKTPCN + C(1) * @DURING("2010")
			...
			' Non-NBR taxes
				smpl %begin_date %end_estimate
					c = 0
				equation _BGDGGREVNNBRCN.LS BGDGGREVNNBRCN = BGDGGREVNNBRER(-1) / 100 * BGDNYGDPMKTPCN + C(1) * @DURING("2010")
			...
			' All Other Taxes
				smpl %begin_date %end_estimate
					c = 0
				equation _BGDGGREVTOTHCN.LS BGDGGREVTOTHCN = BGDGGREVTOTHER(-1) / 100 * BGDNYGDPMKTPCN + C(1) * @DURING("2010")
		...
		'NON TAX REVENUES
			smpl %begin_date %end_estimate
				c = 0
			equation _BGDGGREVNONTCN.LS DLOG(BGDGGREVNONTCN) = DLOG(BGDNYGDPMKTPCN) + C(1) * @DURING("2005")
		
		'GRANTS
			smpl %begin_date %end_estimate
				c = 0
			equation _BGDGGREVGRNTCN.LS DLOG(BGDGGREVGRNTCN) = DLOG(BGDNYGDPMKTPCN) + C(1) * @DURING("2005")
...
'*******************************************************
	smpl %begin_date %end_estimate
		c = 0
	equation _BGDFMLBLPOLYFR.LS(OPTMETHOD=LEGACY) BGDFMLBLPOLYFR/100 = C(1) * BGDFMLBLPOLYFR(-1)/100 + (1-C(1)) * (C(2) + 1.5*(@PC(BGDFPCPITOTLXN) - BGDINFLEXPT)/100 + 0.3 * BGDNYGDPGAP_/100)
	...
	'CURRENT ACCOUNT
		'TRADE			
			'EXPORTS
				...
				smpl %begin_date %end_estimate
					c = 0
				' ' equation _BGDBXGSRMRCHCD.LS(OPTMETHOD=LEGACY) DLOG(BGDBXGSRMRCHCD) = C(1) - C(2)*(LOG(BGDBXGSRMRCHCD(-1))-LOG(BGDXMKT(-1)) + C(3)*LOG(BGDREER(-1))) + C(4)*DLOG(BGDXMKT) - C(3)*DLOG(BGDREER)				
				' equation _BGDBXGSRMRCHCD.LS DLOG(BGDBXGSRMRCHCD) = C(1) - C(2) * (LOG(BGDBXGSRMRCHCD(-1)) - LOG(BGDXMKT(-1)) - LOG(BGDPXKEY(-1))) + C(3) * DLOG(BGDPXKEY) + C(4) * DLOG(BGDXMKT(-1)) + C(10) * T_LR
				equation _BGDBXGSRMRCHCD.LS DLOG(BGDBXGSRMRCHCD) = C(1) - C(2) * (LOG(BGDBXGSRMRCHCD(-1)) - LOG(BGDBXGSRGNFSCD(-1))) + C(3) * DLOG(BGDBXGSRGNFSCD)
			...
			'IMPORTS
				...
				equation _BGDBMGSRMRCHCD.LS DLOG(BGDBMGSRMRCHCD) = C(1) - C(2) * (LOG(BGDBMGSRMRCHCD(-1)) - LOG(BGDBMGSRGNFSCD(-1))) + C(3) * DLOG(BGDBMGSRGNFSCD)
		...
		'PRIMARY AND SECONDARY INCOME
			...
			smpl %begin_date %end_estimate
				c = 0
			equation _BGDBXFSTOTHRCD.LS DLOG(BGDBXFSTOTHRCD) = DLOG(BGDNYGDPMKTPCD) + C(1) * @DURING("2015")
			...
			smpl %begin_date %end_estimate
				c = 0
			equation _BGDBMFSTOTHRCD.LS DLOG(BGDBMFSTOTHRCD) = DLOG(BGDNYGDPMKTPCD) + C(1) * @DURING("2015")
