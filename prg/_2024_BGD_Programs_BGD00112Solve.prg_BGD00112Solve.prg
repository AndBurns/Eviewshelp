...
'Exclusion for row #8, Var:LMPRTTOTL__A
...
MShold.fill(o=2024)   1.14922325225821, 1.39478786707945, 1.51845650879445, 1.58051428162411, 1.61159926669274, 1.62715581348127, 1.63493760414632
series yg=mshold+hold
smpl @all
series BGDLMPRTTOTL__A_2 = BGDLMPRTTOTL__A
smpl %fcst_start %fcst_end

{%model}.exclude(r) BGDLMPRTTOTL_
_BGDLMPRTTOTL_.fit fit

'Mode set to growth: setting shock value (_2) of series BGDLMPRTTOTL__A equal to level consistent with growth rates recorded in excel sheet (hold) 
series BGDLMPRTTOTL__A_2 = BGDLMPRTTOTL__A_2(-1) * (1 + hold / 100)
{%model}.override(m) BGDLMPRTTOTL__A
{%model}.exclude(m) BGDLMPRTTOTL__A
{%model}.exclude(r) BGDLMEMPTOTL_A
{%model}.exclude(r) BGDNYWRTTOTLXN_A
'The following variables were in exogenous mode but were ucnhanged
{%model}.exclude(m) BGDSPPOPTOTL BGDSPPOP1564TO BGDLMEMPTOTL BGDLMUNRSTRL_  BGDNYWRTTOTLXN
...
%Fname="C:\WBG\LocalITUtilities\BGD\Data\BGD2024-14-02~01-16-17soln.wf1"
wfsave(2) %Fname
close BGD2024-14-02~01-16-17soln
wfselect BGDsoln
