...
'Exclusion for row #12, Var:BMGSRMRCHCD
'Placing raw data from excel in hold variable for later treatment, and create the shock variable (_2)

hold.fill(o=2024)   0, 19.5582781606533, 16.1226866382401, 13.9861238343592, 12.4952082148325, 11.1091451203788, 9.56112235315061
smpl @all
series BGDBMGSRMRCHCD_2 = BGDBMGSRMRCHCD
smpl %fcst_start %fcst_end

{%model}.exclude(r) BGDBMGSRMRCHCD_A

'Mode set to growth: setting shock value (_2) of series BGDBMGSRMRCHCD equal to level consistent with growth rates recorded in excel sheet (hold) 
series BGDBMGSRMRCHCD_2 = BGDBMGSRMRCHCD_2(-1) * (1 + hold / 100)
{%model}.override(m) BGDBMGSRMRCHCD
{%model}.exclude(m) BGDBMGSRMRCHCD
{%model}.exclude(r) BGDBMGSRMRCHCD_A
...
'The following variables were in exogenous mode but were ucnhanged
{%model}.exclude(m) BGDBXGSRMRCHCD BGDBXFSTREMTCD BGDBXFSTOTHRCD BGDBMFSTREMTCD BGDBMFSTOTHRCD BGDNYGDPMKTPCD BGDBFCAFFFDICD BGDBFCAFFPFTCD BGDBFCAFOOTHCD BGDBFCAFCAPTCD BGDBFCAFNEOMCD BGDBFCAFRACGCD BGDFIRESTOTLCD
...
%Fname="C:\WBG\LocalITUtilities\BGD\Data\BGD2024-14-02~01-21-29soln.wf1"
wfsave(2) %Fname
close BGD2024-14-02~01-21-29soln
wfselect BGDsoln
