...
'Exclusion for row #49, Var:FMLBLPOLYFR
'Placing raw data from excel in hold variable for later treatment, and create the shock variable (_2)

hold.fill(o=2023)   4.2625502130746, 5.2, 4.3948003690754, 5.08142095540591, 5.78399617236269, 6.37813332262508, 6.81259037895848, 7.08993112060005
smpl @all
series BGDFMLBLPOLYFR_2 = BGDFMLBLPOLYFR
smpl %fcst_start %fcst_end

{%model}.exclude(r) BGDFMLBLPOLYFR_A


'Mode set to level, setting shock value (_2) of series BGDFMLBLPOLYFR equal to values in excel sheet (hold) 
series BGDFMLBLPOLYFR_2 = hold 'BGDFMLBLPOLYFR
{%model}.override(m) BGDFMLBLPOLYFR
{%model}.exclude(m) BGDFMLBLPOLYFR
{%model}.exclude(r) BGDFMLBLPOLYFR_A
'The following variables were in exogenous mode but were ucnhanged
{%model}.exclude(m) BGDFPCPITOTLXN_A BGDNECONPRVTXN_A BGDNECONGOVTXN_A BGDNEGDIFGOVXN_A BGDNEGDIFPRVXN_A BGDNEEXPGNFSXN_A BGDNEIMPGNFSXN_A BGDPANUSATLS_A
...
%Fname="C:\WBG\LocalITUtilities\BGD\Data\BGD2024-05-02~10-31-40soln.wf1"
wfsave(2) %Fname
close BGD2024-05-02~10-31-40soln
wfselect BGDsoln
