...
'*******************************************************
	'VOLUMES
		...
		equation _BGDNECONPRVTKN.LS DLOG(BGDNECONPRVTKN) = C(1) -  C(2) * (LOG(BGDNECONPRVTKN(-1)) - LOG((BGDNYYWBTOTLCN(-1)*(1-BGDGGREVDRCTER(-1)/100)+BGDBXFSTREMTCD(-1)*BGDPANUSATLS(-1))/BGDNECONPRVTXN(-1))) + C(3) * DLOG((BGDNYYWBTOTLCN*(1-BGDGGREVDRCTER/100)+BGDBXFSTREMTCD*BGDPANUSATLS)/BGDNECONPRVTXN) + C(10) * T_LR
...
'*******************************************************
	...
	'EXPENDITURES
		...
		BGD.append @IDENTITY BGDGGEXPCRNTCN = BGDGGEXPWAGECN + BGDGGEXPINTPCN + BGDGGEXPGNFSCN 
