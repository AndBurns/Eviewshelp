...
'Exclusion for row #41, Var:BFCAFFFDICD
'Placing raw data from excel in hold variable for later treatment, and create the shock variable (_2)

hold.fill(o=2024)   10, 10, 10, 10, 10, 10, 10
smpl @all
series BGDBFCAFFFDICD_2 = BGDBFCAFFFDICD
smpl %fcst_start %fcst_end

{%model}.exclude(r) BGDBFCAFFFDICD_A

'Mode set to growth: setting shock value (_2) of series BGDBFCAFFFDICD equal to level consistent with growth rates recorded in excel sheet (hold) 
series BGDBFCAFFFDICD_2 = BGDBFCAFFFDICD_2(-1) * (1 + hold / 100)
{%model}.override(m) BGDBFCAFFFDICD
{%model}.exclude(m) BGDBFCAFFFDICD
{%model}.exclude(r) BGDBFCAFFFDICD_A
...
'The following variables were in exogenous mode but were ucnhanged
{%model}.exclude(m) BGDBXGSRMRCHCD BGDBMGSRMRCHCD BGDBXFSTREMTCD BGDBXFSTOTHRCD BGDBMFSTREMTCD BGDBMFSTOTHRCD BGDNYGDPMKTPCD BGDBFCAFFPFTCD BGDBFCAFOOTHCD BGDBFCAFCAPTCD BGDBFCAFNEOMCD BGDBFCAFRACGCD BGDFIRESTOTLCD
...
%Fname="C:\WBG\LocalITUtilities\BGD\Data\BGD2024-14-02~01-36-30soln.wf1"
wfsave(2) %Fname
close BGD2024-14-02~01-36-30soln
wfselect BGDsoln
