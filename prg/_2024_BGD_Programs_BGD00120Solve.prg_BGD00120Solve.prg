...
'Exclusion for row #19, Var:BXFSTREMTCD
'Placing raw data from excel in hold variable for later treatment, and create the shock variable (_2)

hold.fill(o=2024)   5, 4, 4, 4, 4, 4, 4
smpl @all
series BGDBXFSTREMTCD_2 = BGDBXFSTREMTCD
smpl %fcst_start %fcst_end

{%model}.exclude(r) BGDBXFSTREMTCD_A

'Mode set to growth: setting shock value (_2) of series BGDBXFSTREMTCD equal to level consistent with growth rates recorded in excel sheet (hold) 
series BGDBXFSTREMTCD_2 = BGDBXFSTREMTCD_2(-1) * (1 + hold / 100)
{%model}.override(m) BGDBXFSTREMTCD
{%model}.exclude(m) BGDBXFSTREMTCD
{%model}.exclude(r) BGDBXFSTREMTCD_A
...
'The following variables were in exogenous mode but were ucnhanged
{%model}.exclude(m) BGDBXGSRMRCHCD BGDBMGSRMRCHCD BGDBXFSTOTHRCD BGDBMFSTREMTCD BGDBMFSTOTHRCD BGDNYGDPMKTPCD BGDBFCAFFFDICD BGDBFCAFFPFTCD BGDBFCAFOOTHCD BGDBFCAFCAPTCD BGDBFCAFNEOMCD BGDBFCAFRACGCD BGDFIRESTOTLCD
...
%Fname="C:\WBG\LocalITUtilities\BGD\Data\BGD2024-14-02~01-34-58soln.wf1"
wfsave(2) %Fname
close BGD2024-14-02~01-34-58soln
wfselect BGDsoln
