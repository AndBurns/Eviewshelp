...
'Exclusion for row #14, Var:NYGDPDISCCN
...
smpl @all
series BGDNYGDPDISCCN_2 = BGDNYGDPDISCCN
smpl %fcst_start %fcst_end

{%model}.exclude(r) BGDNYGDPDISCCN_A

'Mode set to contr: setting shock value (_2) of series BGDNYGDPDISCCN equal to level consistent with contribution to GDP growth recorded in excel sheet (hold) 
series BGDNYGDPDISCCN_2 =BGDNYGDPDISCCN_2(-1) + ((hold / 100))* BGDNYGDPMKTPCN(-1)
{%model}.override(m) BGDNYGDPDISCCN
{%model}.exclude(m) BGDNYGDPDISCCN
'The following variables were in exogenous mode but were ucnhanged
{%model}.exclude(m) BGDNEGDISTKBCN
...
%Fname="C:\WBG\LocalITUtilities\BGD\Data\BGD2024-14-02~08-20-00soln.wf1"
wfsave(2) %Fname
close BGD2024-14-02~08-20-00soln
wfselect BGDsoln
