...
'Exclusion for row #6, Var:NECONPRVTKN
'Placing raw data from excel in hold variable for later treatment, and create the shock variable (_2)

hold.fill(o=2023)   5, 7.34325359179904, 7.28916877679957, 6.79979434379896, 6.53392196119493, 6.37075590792593, 6.28937508779817, 6.26964373557206
smpl @all
...
{%model}.exclude(m) BGDNEGDIFPRVKN BGDNEGDISTKBKN BGDNEEXPGNFSKN BGDNEIMPGNFSKN BGDNYGDPDISCKN BGDNYGDPTFP
...
%Fname="C:\WBG\LocalITUtilities\BGD\Data\BGD2024-01-02~11-48-06soln.wf1"
wfsave(2) %Fname
close BGD2024-01-02~11-48-06soln
wfselect BGDsoln
