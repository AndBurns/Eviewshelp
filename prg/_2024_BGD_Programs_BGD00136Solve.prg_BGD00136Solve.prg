...
'Exclusion for row #48, Var:NYTAXNINDCN_A
...
MShold.fill(o=2024)   12.1321432713431, 11.2641780769043, 12.3027942209839, 12.7117807637766, 13.2851806707211, 13.9072981186468, 14.5865266784941
series yg=mshold+hold
smpl @all
series BGDNYTAXNINDCN_A_2 = BGDNYTAXNINDCN_A
smpl %fcst_start %fcst_end

_BGDNYTAXNINDCN.fit fit
...
smpl @all
series BGDNYTAXNINDCN_A_2 = BGDNYTAXNINDCN_A
series orig_AF = BGDNYTAXNINDCN_A
series y = BGDNYTAXNINDCN_0
smpl %fcst_start %solve_end
'
...
series orig_add_AF = BGDNYTAXNINDCN_A 
series BGDNYTAXNINDCN_A_S = BGDNYTAXNINDCN_A
'Now caculate the additive add factor _A_S consistent with the desired growth path
smpl %fcst_start %solve_end
series BGDNYTAXNINDCN_A_S = BGDNYTAXNINDCN_A+Y(-1)*(delta_AF_add/100)
series BGDNYTAXNINDCN_A_add = BGDNYTAXNINDCN_A
...
test.override(m) BGDNYTAXNINDCN_A
test.exclude(m)  BGDNYTAXNINDCN_A
...
smpl %solve_start %solve_end
series BGDNYTAXNINDCN = BGDNYTAXNINDCN_s
series BGDNYTAXNINDCN_A = orig_AF


'Calculate new intercept-type add factor
smpl %solve_start %solve_end
{%model}.addinit(v=n,s=a) BGDNYTAXNINDCN
...
series BGDNYTAXNINDCN_A_2 = BGDNYTAXNINDCN_A
series BGDNYTAXNINDCN_A = orig_AF
series BGDNYTAXNINDCN= orig_ser
{%model}.override(m) BGDNYTAXNINDCN_A
{%model}.exclude(m) BGDNYTAXNINDCN_A
'The following variables were in exogenous mode but were ucnhanged
{%model}.exclude(m) BGDNYTAXNINDKN_A BGDNVAGRTOTLKN_A BGDNVINDTOTLKN_A BGDNYGDPCPSHXN_A BGDNVAGRTOTLXN_A BGDNVINDTOTLXN_A
...
%Fname="C:\WBG\LocalITUtilities\BGD\Data\BGD2024-14-02~08-20-51soln.wf1"
wfsave(2) %Fname
close BGD2024-14-02~08-20-51soln
wfselect BGDsoln
