...
# Set to track previously processed lines
processed_lines = set()
        ...
        if first_match:
            ...
            for line in content:
                if line not in processed_lines:
                    dataset.append(line)  # Add to dataset
...
Use only the following pieces of context to answer the question. Don't give answers based on programming languages other than EViews. Don't make up any new information:
